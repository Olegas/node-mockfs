(function(){
   ...
   var path = require('path'),
       ...
       O_RDWR = constants.O_RDWR || 0,
       O_RDONLY = constants.O_RDONLY || 0,
       O_TRUNC = constants.O_TRUNC || 0,
       O_CREAT = constants.O_CREAT || 0,
       O_WRONLY = constants.O_WRONLY || 0,
       O_EXCL = constants.O_EXCL || 0,
       O_APPEND = constants.O_APPEND || 0;
   ...
   module.exports = {
      ...
      _truncate: function() {
         ...
         args.unshift(this);
         call = Function.prototype.bind.apply(this._truncateSync, args);
      ...
      _open: function() {
         ...
         args.unshift(this);
         call = Function.prototype.bind.apply(this._openSync, args);
         process.nextTick(function(){
            try {
               cb(null, call());
            } catch(e) {
      ...
      _fstat: function() {
         ...
         args.unshift(this);
         call = Function.prototype.bind.apply(this._fstatSync, args);
         process.nextTick(function(){
            try {
      ...
      _close: function() {
         ...
         args.unshift(this);
         call = Function.prototype.bind.apply(this._closeSync, args);
         process.nextTick(function(){
            try {
               cb(null, call(), arguments[1]);
            } catch(e) {
